...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Retry Failed Executions >> Retry button appears on failed execution
- Location: e2e\full-flow.spec.ts:171:9
...
- generic [active] [ref=f2e1]:
  - banner [ref=f2e2]:
    - generic [ref=f2e3]:
      - link "enrichly.job automation" [ref=f2e4] [cursor=pointer]:
        - /url: /
      - navigation [ref=f2e9]:
        - link "Overview" [ref=f2e10] [cursor=pointer]:
          - /url: /
        - link "New job" [ref=f2e11] [cursor=pointer]:
          - /url: /jobs/new
      - generic [ref=f2e12]:
        - generic [ref=f2e13]: Open for runs
        - link "New job" [ref=f2e15] [cursor=pointer]:
          - /url: /jobs/new
        - link "Sign in" [ref=f2e18] [cursor=pointer]:
          - /url: /login
    - generic [ref=f2e20]:
      - generic [ref=f2e21]:
        - generic [ref=f2e22]: HTTP jobs
        - generic [ref=f2e23]: +
      - generic [ref=f2e24]:
        - generic [ref=f2e25]: Interval scheduler
        - generic [ref=f2e26]: +
      - generic [ref=f2e27]:
        - generic [ref=f2e28]: Parallel workers
        - generic [ref=f2e29]: +
      - generic [ref=f2e30]:
        - generic [ref=f2e31]: Smart retries
        - generic [ref=f2e32]: +
      - generic [ref=f2e33]: Full history
  - main [ref=f2e35]:
    - generic [ref=f2e36]:
      - generic [ref=f2e37]:
        - generic [ref=f2e41]:
          - paragraph [ref=f2e42]: Automate the boring.Observe everything.
          - paragraph [ref=f2e43]: Jobs, workers, retries and full execution history — in one connected platform.
        - paragraph [ref=f2e44]: enrichly · job automation
      - generic [ref=f2e45]:
        - heading "Welcome back" [level=1] [ref=f2e46]
        - paragraph [ref=f2e47]: Sign in to your automation workspace.
        - generic [ref=f2e48]:
          - generic [ref=f2e49]:
            - generic [ref=f2e50]: Email
            - textbox [ref=f2e51]: demo@enrichly.dev
          - generic [ref=f2e52]:
            - generic [ref=f2e53]: Password
            - textbox [ref=f2e54]: password123
          - button "Sign in" [ref=f2e55] [cursor=pointer]
          - paragraph [ref=f2e58]:
            - text: No account?
            - link "Register" [ref=f2e59] [cursor=pointer]:
              - /url: /register
  - contentinfo [ref=f2e60]:
    - generic [ref=f2e61]:
      - generic [ref=f2e62]: enrichly.
      - generic [ref=f2e63]: Job automation · PostgreSQL is the source of truth · atomic claims · exponential backoff
  - alert [ref=f2e64]
```
