...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Responsive Design >> Tablet viewport works
- Location: e2e\full-flow.spec.ts:339:9
...
- generic [active] [ref=f1e1]:
    ...
    - generic [ref=f1e3]:
      ...
      - navigation [ref=f1e9]:
        ...
        - link "New job" [ref=f1e11] [cursor=pointer]:
          - /url: /jobs/new
      - generic [ref=f1e12]:
        - link "New job" [ref=f1e13] [cursor=pointer]:
          - /url: /jobs/new
        - link "Sign in" [ref=f1e16] [cursor=pointer]:
          - /url: /login
    - generic [ref=f1e18]:
      - generic [ref=f1e19]:
        - generic [ref=f1e20]: HTTP jobs
        - generic [ref=f1e21]: +
      - generic [ref=f1e22]:
        - generic [ref=f1e23]: Interval scheduler
        - generic [ref=f1e24]: +
      - generic [ref=f1e25]:
        - generic [ref=f1e26]: Parallel workers
        - generic [ref=f1e27]: +
      - generic [ref=f1e28]:
        - generic [ref=f1e29]: Smart retries
        - generic [ref=f1e30]: +
      - generic [ref=f1e31]: Full history
  - main [ref=f1e33]:
    - generic [ref=f1e34]:
      - generic [ref=f1e35]:
        - generic [ref=f1e39]:
          - paragraph [ref=f1e40]: Automate the boring.Observe everything.
          - paragraph [ref=f1e41]: Jobs, workers, retries and full execution history — in one connected platform.
        - paragraph [ref=f1e42]: enrichly · job automation
      - generic [ref=f1e43]:
        - heading "Welcome back" [level=1] [ref=f1e44]
        - paragraph [ref=f1e45]: Sign in to your automation workspace.
        - generic [ref=f1e46]:
          - generic [ref=f1e47]:
            - generic [ref=f1e48]: Email
            - textbox [ref=f1e49]: demo@enrichly.dev
          - generic [ref=f1e50]:
            - generic [ref=f1e51]: Password
            - textbox [ref=f1e52]: password123
  ...
  - contentinfo [ref=f1e58]:
    - generic [ref=f1e59]:
      - generic [ref=f1e60]: enrichly.
      - generic [ref=f1e61]: Job automation · PostgreSQL is the source of truth · atomic claims · exponential backoff
  - alert [ref=f1e62]
```
