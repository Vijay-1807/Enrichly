...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Real-time Updates (SignalR) >> Execution page shows realtime indicator
- Location: e2e\full-flow.spec.ts:304:9
