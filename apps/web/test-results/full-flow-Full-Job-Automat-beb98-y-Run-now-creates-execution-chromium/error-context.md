...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Run Now & Execution History >> Run now creates execution
- Location: e2e\full-flow.spec.ts:127:9
