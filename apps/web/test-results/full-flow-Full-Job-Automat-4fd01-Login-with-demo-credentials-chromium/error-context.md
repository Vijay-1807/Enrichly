...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Authentication & Authorization >> Login with demo credentials
- Location: e2e\full-flow.spec.ts:39:9
