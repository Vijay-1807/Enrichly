...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Dashboard & Stats >> Dashboard shows workers section
- Location: e2e\full-flow.spec.ts:259:9
