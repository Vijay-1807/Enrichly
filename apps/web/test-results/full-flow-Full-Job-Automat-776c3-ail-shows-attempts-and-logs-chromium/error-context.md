...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Run Now & Execution History >> Execution detail shows attempts and logs
- Location: e2e\full-flow.spec.ts:152:9
