...
- Name: full-flow.spec.ts >> Full Job Automation Platform - Requirements Verification >> Authentication & Authorization >> Logout works
- Location: e2e\full-flow.spec.ts:44:9
